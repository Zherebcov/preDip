...
public class MnistClassifier {
  ...
  public static void main(String[] args) throws Exception {
    ...
    log.info("Create DataSet for {} ms",timeConsumedMillis);
    ...
    net.init();
    net.setListeners(new ScoreIterationListener( (int)(60000/batchSize/30)));
    log.debug("Total num of params: {}", net.numParams());


    finish = System.currentTimeMillis();
    timeConsumedMillis = finish - start;
    log.info("Create Model for {} ms",timeConsumedMillis);
    start = System.currentTimeMillis();
    ...
    for (int i = 0; i < nEpochs; i++) {
      ...
      finish = System.currentTimeMillis();
      timeConsumedMillis = finish - start;
      log.info("Completed epoch {} ms",timeConsumedMillis);
      start = System.currentTimeMillis();
      ...
      finish = System.currentTimeMillis();
      timeConsumedMillis = finish - start;
      log.info("Evaluation epoch {} ms",timeConsumedMillis);
      start = System.currentTimeMillis();
    ...
    finish = System.currentTimeMillis();
    timeConsumedMillis = finish - start;
    log.info("Training end {} ms",timeConsumedMillis);
    start = System.currentTimeMillis();
    ...
    finish = System.currentTimeMillis();
    timeConsumedMillis = finish - start;
    log.info("Save model {} ms",timeConsumedMillis);
  }
